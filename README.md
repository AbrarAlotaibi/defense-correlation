...
and Why Layered Defenses Compound Only Under Independence,"** submitted to *Information Fusion*.

<p align="center">
  <img src="paper/figures/graphical_abstract.png"
       alt="Layering assumes each defense is blind somewhere different, so an attack is stopped by whichever layer covers it. Measured, the layers are blind in the same place and one attack passes through the whole stack to the model."
       width="900">
</p>
...
| Graphical abstract (schematic, carries no measured number) | `paper/figures/graphical_abstract.pdf`, rebuilt by `scripts/make_graphical_abstract.py` |
| Difficulty stratification, k-of-n curve, refusal floor, reproducibility block | `paper/SUPPLEMENTARY_ANALYSES.md` |
| Permutation inference, five-fold re-judging, external-threshold transfer | `paper/ROBUSTNESS_ANALYSES.md` |
...
scripts/          00..23 pipeline and analysis stages, run_pipeline.sh, slurm_pipeline.sbatch,
                  make_figures.py, make_graphical_abstract.py
...
paper/            drop-in .tex inserts (results, robustness, fusion, estimand), figures/, and
                  two supplements: SUPPLEMENTARY_ANALYSES.md and ROBUSTNESS_ANALYSES.md
